                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto ms-lg-3">
                            ...
                            <li class="nav-item dropdown menu_list">
                                <a class="nav-link dropdown-toggle" href="#" id="navbarExplore" role="button" data-bs-toggle="dropdown" aria-expanded="false">Explore</a>
                                <div class="dropdown-menu w-100 p-0" aria-labelledby="navbarExplore">
                                    <div class="row g-0">
                                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 d-xl-block d-lg-block d-md-none d-none">
                                            <div class="dropdown-img " style="background-image: url({{asset('images/dropdown-img.jpg') }});">
                                        ...
                                        <div class="col-12 col-md-12 col-lg-6">
                                            <div class="row m-3 m-lg-6">
                                                <div class="col-md-3">
                                                    <h5 class="mb-2 text-uppercase h6 text-primary fw-bold">Inspector</h5>
                                                    <ul class="list-unstyled">
                                                        <li><a class="dropdown-item" href="listing-list-view.html">Top Rated</a></li>
                                                        <li><a class="dropdown-item" href="listing-grid-view.html">Featured</a></li>
                                                        <li><a class="dropdown-item" href="list-with-map.html">Popular</a></li>
                                                ...
                                                <div class="col-md-3">
                                                    <h5 class="mb-2 text-uppercase h6 text-primary fw-bold">Appraisers</h5>
                                                ...
                                                <div class="col-md-3">
                                                    <h5 class="mb-2 text-uppercase h6 text-primary fw-bold">Realtors</h5>
                                                    <ul class="list-unstyled">
                                                        <li><a class="dropdown-item" href="listing-list-view.html">Top Rated</a></li>
                                                        <li><a class="dropdown-item" href="listing-grid-view.html">Featured</a></li>
                                                        <li><a class="dropdown-item" href="list-with-map.html">Popular</a></li>
                                                ...
                                                <div class="col-md-3">
                                                    <h5 class="mb-2 text-uppercase h6 text-primary fw-bold">Attornies</h5>
                                                    <ul class="mega-menu-list list-unstyled">
                                                        <li><a class="dropdown-item" href="listing-list-view.html">Top Rated</a></li>
                                                        <li><a class="dropdown-item" href="listing-grid-view.html">Featured</a></li>
                                                        <li><a class="dropdown-item" href="list-with-map.html">Popular</a></li>
